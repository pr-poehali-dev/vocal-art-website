  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden hero-container">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1516280440614-37939bbacd81?ixlib=rb-4.0.3&auto=format&fit=crop&w=1650&q=80')",
      ...
      <div className="container mx-auto px-4 z-10 text-center">
        ...
        >
          <Button
            size="lg"
            className="bg-vocal-purple hover:bg-vocal-purple/90 text-white px-8 py-6 text-lg"
          >
